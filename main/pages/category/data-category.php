         ...
         <form action="" method="POST">
            <div class="navbar-nav align-items-center border-primary rounded px-4">
               <div class="input-group">
                  <input type="text" name="category_name" class="form-control border-primary" placeholder="Cari Kategori"
                     value="<?= (isset($_SESSION['value']['category_name'])) ? $_SESSION['value']['category_name'] : null; ?>">
         ...
         <nav aria-label="Page navigation">
            <ul class="pagination justify-content-end float-end me-5">
               ...
               <?php if ($page > 1): ?>
                  <?php if ($page > 2): ?>
                     <li class="page-item">
                        <a class="page-link" href="?page=category/data-category&pagination=1">Home</a>
                     </li>
                  <?php endif; ?>
                  <li class="page-item">
               ...
               if ($totalPages > 3) {
                  ...
                  for ($i = max(1, $page - 1); $i <= min($totalPages, $page + 1); $i++) {
                     ...
                     echo '<a class="page-link" href="?page=category/data-category&pagination=' . $i . '">' . $i . '</a>';
                     echo '</li>';
                  }
