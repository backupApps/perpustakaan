   ...
   <div class="misc-wrapper">
      ...
      <div class="d-flex justify-content-center mt-5">
         ...
         <img src="assets/img/illustrations/misc-mask-light.png" alt="misc-error"
            class="misc-bg d-none d-lg-inline-block" height="172" data-app-light-img="illustrations/misc-mask-light.png"
            data-app-dark-img="illustrations/misc-mask-dark.png" />
         <div class="d-flex flex-column align-items-center">
            <img src="assets/img/illustrations/404.png" alt="misc-error" class="misc-model img-fluid z-1" width="780" />
            <div>
               <a href="?page=dashboard" class="btn btn-primary text-center my-6">Back to Dashboard</a>
            </div>
         </div>
      </div>
   </div>
