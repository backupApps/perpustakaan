                  ...
                  <div class="row mt-1 g-5">
                     ...
                     <div class="col-md-4">
                        ...
                        <select
                           ...
                           value="<?php echo $data['category']; ?>" name="category">
                           <option value="">-- Select Category --</option>
                           <?php while($var = mysqli_fetch_array($selectCategory)) { ?>
                           <option value="<?php echo $var['code'];?>"
                              <?php //echo ($var['code'] == $selectCategory['code']) ? 'selected' : ''; ?>
                     ...
                     <div class="col-md-4">
                        ...
                        <select
                           ...
                           value="<?php echo $data['publisher']; ?>" name="publisher">
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="file"
                           ...
                           value="<?php echo $data['cover']; ?>" name="cover" />
                     ...
                     <div class="col-12">
                        ...
                        <div class="input-group">
                           <textarea
                              ...
                              rows="2"><?php echo $data['synopsis']; ?></textarea>
                        </div>
